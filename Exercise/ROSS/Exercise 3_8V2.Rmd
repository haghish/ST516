...
In this case we can estimate it by applying Monte Carlo integration. This is easily done, since our target region in $\mathbb{R}^2$ is a square $0 \leq x \leq 1$, $0 \leq y \leq 1$. It is thus sufficent (without any manipulation of the integrand and the integral, to fit the Monte Carlo integration scheme), to generate $(U_{1(1)}, U_{2(1)}), (U_{1(2)},U_{2(2)}),. . .,(U_{1(n)},U_{2(n)})$ iid pairs of uniform random variables on $\left[0, 1\right]$, to estimate the volume of the integral.
